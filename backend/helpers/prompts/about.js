...
🏛️ **Chat History**: Easily access previous chat sessions from the 'History' tab, allowing you to revisit old discussions and insights.

🎨 **Prompt System**: Utilize pre-designed prompts to get instant, accurate responses, or create your own prompts for later use.

💾 **Custom API Keys**: Enter your own API keys to customize the experience and get more personalized responses.
...
- Pressing the hot keys \`cmd + K\` will get you focused on the Copilot prompt box for you to type in your web3 queries
- Type in your command/prompt into the text input section of the cmd bar or select on any example prompt on the new chat page and click enter!
- Voila! Your web3 queries will be cleared within the Chat interface
...
- Your credits refresh by 25 credits every 24 hours, you can earn more credits by doing tasks and referring your frens
...
- How do i earn more credits?
    ...
    2. Do Tasks - Each task earns you 5 credits too
    
    You can do tasks and get your referral code from the “Earn more Credits” in the side panel.
    
- How many credits do I get a day?
    
    You get 20 credits everyday. We add 15 credits to your previous balance every 24 hours. The time clock is started from the moment you connected your wallet for the first time.
    
- I have my own Open AI API key, how can I input it?
...
- How do I view my chat history?
    ...
    It will be visible on the side panel. Note: You must connect your wallet to view chat history!
    
- How do I share my session?
    
    On the side panel, right next to the chat heading, you can view two buttons, the first button is the share button. Click on that to copy the session link to your clipboard
    
- How do I delete a chat?
    
    On the side panel, right next to each chat heading, you will see a delete button on the right, click that to delete a chat session.
    

# Help 🧑‍🚒

Need help? fear not, we're all ears! At Layer-E, we value your feedback more than a sloth values its nap time. Seriously, we can't get enough of it! Whether you have a query, a bug to report, a feature request, or just want to chat about your day:

Give feedback at: 

- [Tell us everything, in detail](https://tally.so/r/mRdobj)
- [Keep it quick and short](https://tally.so/r/nPD9be)

Or [join us on our Discord Server](https://discord.gg/QkEdzMmvZf) and raise a ticket!

# About Layer-E

Layer-E is a an innovative web3 product company building the ultimate product suite for all things web3. From creator tools, analytics to assistants, Layer-E aims to make the web3 experience more easier, accessible and scaleable to the masses. Layer-E is all about velocity, we ship products fast, that solve problems, and influence the web3 experiences of our users. 
...
The only personal information we collect from you is your wallet address when you connect your wallet to access our service. We do not collect any other personal data, such as email addresses, first names, or last names.

Additionally, we use Google Analytics to collect anonymized, aggregated data about your use of our service. This may include information about your device, browser, and usage patterns.
...
We take the security of your information seriously and have implemented appropriate technical and organizational measures to protect it. However, please note that no method of transmission over the internet or method of electronic storage is 100% secure, and we cannot guarantee the absolute security of your wallet address.
...
To access certain features of the Service, you must connect your wallet to our site. You are responsible for safeguarding the security of your wallet and for any activities or actions under your wallet address.

**3. Usage Limits**

Each user is limited to 25 credits per day. We reserve the right to monitor usage and enforce these limits at our discretion.
...
If you have any questions about these Terms, please contact us by email at hello@layer-e.com.

# Layer-E Socials
Email: hello@layer-e.com
Website: https://www.layer-e.com/
...
Layer-E is working on no-code tools to help brands and creators add a web3 layer over their existing business/platform. Our focus is on the adoption of NFTs and Web3 technology, building utility-led tools for protocols to have a sustainable ecosystem.

We are at the forefront of innovation in the web3 space. As long-time students and enthusiasts of both technologies, we want to make a meaningful contribution to both product and narrative.

# 🔭 Humanizing Tokens With Culture

[Layer-E](https://layer-e.com) is building **Composable Culture Collectibles for Creators and Companies.**

That’s a mouthful! So what does that mean?

We’re a platform for a new primitive of collectibles, that rethinks user engagement in web3; built for consumer brands and forward thinking creators.

Collectibles are a file format, not the destination. We’re the first time collectibles can do something unique, for a crypto-naive audience, at Social Media scale. The Layer-E suite of products is the perfect solution for anyone looking to make their mark in the world of NFTs and web3, and tap into the immense revenue potential of this rapidly growing industry. Our collectible-first approach allows companies and creators to build strong, authentic connections with their audience, and stand out in a crowded marketplace.

# 🎯 The Layer-E Product Stack

The results from SEO and cookies-based user engagement is getting progressively narrower for brands. Collectibles represent the next paradigm shift. Layer-E’s CRM product suite leverages the ease of use and distribution of web2, along with the privacy and security of web3.

**The Layer-E product exists across the spectrum of Identity, Immersion and Interaction.**

This is what the Soul, the Biome and the Backstage products power. They are complemented with an NFT tooling and analytics stack that we call the Surfaceboard. Together they combine to become the Collectible Relationship Management engine for Brands and Creators.
